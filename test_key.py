...
def test_key(last_round_key, plaintext, ciphertext):
    ...
    aes = AES.new(secret_key.tobytes(), AES.MODE_ECB)
    calculated_cipher = np.array(bytearray(aes.encrypt(plaintext.tobytes())), dtype=np.uint8)
...
if __name__ == "__main__":
    ...
    with open("./key.txt", "rb") as keyF:
        ...
        last_round_key_hex = next(reader)
